...
TcantusVIII = \lyricmode {\set ignoreMelismata = ##t
	...
	im -- ple -- vit bo -- \skip1 \skip1 \skip1 \skip1 nis
...
TaltusVIII = \lyricmode {\set ignoreMelismata = ##t
	...
	im -- ple -- vit bo -- \skip1 \skip1 \skip1 \skip1 \skip1 \skip1 \skip1 \skip1 \skip1 \skip1 nis
	et di -- vi -- tes,
	et di -- \skip1 \skip1 \skip1 \skip1 \skip1 vi -- tes
	di -- mi -- sit in a --\skip1 \skip1 nes,
...
TtenorVIII = \lyricmode {\set ignoreMelismata = ##t
	...
	et di -- vi -- tes
	di -- mi -- sit in a -- nes,
	di -- mi -- \skip1 \skip1 \skip1 \skip1 \skip1 \skip1 \skip1 sit in a -- nes,
}

quintusVIII = \relative do' {
		\clef "treble_8"
		% Tenor dans le manuscript
		r\breve
		r\breve
		r1 r2 re
		re mib re1
...
cantusX = \relative do'' {
  \sectionLabel "Versum 6 (suite)"
		...
		sib2 do re1
		r1 fa~
		fa2 fa2~fa4 mib8 re mib2
		re2 re4 do sib2 la4 sol
		la1 re2 re
		fa1 fa2 mi~
		mi4 re re2~re4 dod8 si dod2
		re1 r2 fa~
		fa re la mi'
		mi2. mi4 mi2 fa
		mi sol2~sol do,~
...
TcantusX = \lyricmode {\set ignoreMelismata = ##t
	...
	ad __\skip1 pa -- \skip1 \skip1 \skip1 \skip1 tres nos -- \skip1 \skip1 \skip1 \skip1 \skip1 tros,
	ad pa -- tres nos -- \skip1 \skip1 \skip1 \skip1 \skip1 \skip1 \skip1 tros
	A -- \skip1 bra -- ham
	et se -- mi -- ni e -- ius in __\skip1 sae -- \skip1 cu -- la,
	et se -- mi -- ni e -- ius in sae -- cu -- la,
	e -- \skip1 \skip1 \skip1 \skip1 \skip1 \skip1 ius in sae -- cu -- la. __\skip1
}
...
TsextusX = \lyricmode {\set ignoreMelismata = ##t
	...
	Si -- cut lo -- cu -- tus est
	ad __\skip1 pa -- \skip1 tres nos -- \skip1 \skip1 \skip1 tros,
	ad pa -- tres nos -- tros
	A -- bra -- ham __\skip1 \skip1 \skip1 \skip1 \skip1 \skip1
	et se -- \skip1 mi -- ni e -- ius in sae -- cu -- la,
	et se -- mi -- ni e -- ius,
	et se -- mi -- ni __\skip1 e -- ius in __\skip1 \skip1 \skip1 sae -- cu -- la.
}
...
TaltusX = \lyricmode {\set ignoreMelismata = ##t
	Si -- cut lo -- cu -- tus est,
	Si -- cut lo -- cu -- tus est
	ad __\skip1 \skip1 \skip1 \skip1 pa -- tres nos -- \skip1 \skip1 \skip1 \skip1 \skip1 \skip1 \skip1 tros,
	ad pa -- tres nos -- \skip1 tros
	A -- \skip1 bra -- ham
	et se -- mi -- ni e -- ius in sae -- \skip1 cu -- la,
	et se -- mi -- ni e -- ius,
	et se -- mi -- ni e -- \skip1 ius in sae -- \skip1 cu -- la.
   }
...
cantusXII = \relative do'' {
  \sectionLabel "Doxologie (suite)"
		...
		la2 la sib la
		sol fa r1
		% Echange avec voix de Sextus ici
		r1 r2 re'
		mib re do4 sib sib2~
...
altusXII = \relative do'' {
		...
		fa2. fa4 sol2 re
		mi sol fad sol~
		sol4 sol sol2~sol4 fad8 mi fad2
		sol1 fad2. fad4
		sol2 sol la re,~
...
TaltusXII = \lyricmode {\set ignoreMelismata = ##t
	...
	si -- \skip1 cut e -- rat,
	si -- cut e -- rat,
	in __\skip1 prin -- ci -- \skip1 \skip1 \skip1 \skip1 pi  -- o
	et nunc et sem -- per,
	et nunc et sem -- per
	et in sae -- cu -- la sae -- cu -- lo -- \skip1 rum, A -- \skip1 \skip1 \skip1 \skip1 men,
